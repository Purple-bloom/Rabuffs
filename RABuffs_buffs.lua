...
RAB_Buffs = {
  ...
  anysacrifice = { name = "Any Sacrifice", identifiers = {
	...
	demonslaying = { name = "Elixir of Demonslaying", identifiers = { { tooltip = "Elixir of Demonslaying", texture = "SPELL_HOLY_RETRIBUTIONAURA", spellId = 11406 } }, grouping = "Melee", itemId = 9224 },
    ...
    { tooltip = "Gordok Green Grog", texture = "INV_Drink_03", spellId = 22789 }, -- doesn't stack with green grog
	...
	gordokgreengrog = { name = "Gordok Green Grog", identifiers = {
